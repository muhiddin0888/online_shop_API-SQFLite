...
//  METHODS USED ONLY CARD SCREEN
  ListView _cardProducts() {
    return ListView(
        ...
        (index) => Container(
          ...
          child: Row(
            children: [
              ...
              IconButton(
                onPressed: () {
                  MyRepository.deleteCachedTodById(id: products[index].id!);
  ...
  TextButton _clearButton(BuildContext context) {
    return TextButton(
      onPressed: () async {
        showDialog(
            context: context,
